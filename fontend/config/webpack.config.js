...
module.exports = function (webpackEnv) {
	...
	return {
		...
		devtool: isEnvProduction ?
			shouldUseSourceMap ? 'source-map' : false : isEnvDevelopment && 'cheap-module-source-map',
		...
		optimization: {
			...
			splitChunks: {
				...
				cacheGroups: {
					vendors: {
						test: /[\\/]node_modules[\\/](react|react-router|react-dom|axios|dayjs).*\.js/,
						name: 'vendors',
						chunks: 'all',
						priority: -10
					},
					antd: {
						test: /[\\/]node_modules[\\/](|@ant-design|antd).*\.js/,
						name: 'ant-design',
						chunks: 'all',
						priority: -30
					},
					markdown: {
						test: /[\\/]node_modules[\\/](react-markdown|highlight.js).*\.js /,
						name: 'markdown',
						chunks: 'all',
						priority: -40
					},
