...
export class ArticleEntity extends BaseEntity {
  ...
  @OneToOne(
    ...
    ArticleContentEntity => ArticleContentEntity.article,
  )
  content: ArticleContentEntity;

  @ManyToOne(
    type => CategoryEntity,
    CategoryEntity => CategoryEntity.category_id,
  )
  ...
  public static async createArticle(
    ...
    return getConnection().transaction(async transactionalEntityManager => {
      createArticleDto.content = xss(createArticleDto.content).trim(); // 防止xss
  ...
  public static async updateArticle(
    ...
    return getConnection().transaction(async transactionalEntityManager => {
      ...
      if (content) {
        await ArticleContentEntity.updateArticleContent(
