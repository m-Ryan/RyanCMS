...
export default function ArticleManager() {
	...
	const { getAdminList, articleListState, getAdminListLoading, } = useArticleList();
	...
	}, [categoryId, getAdminList, page, title]);
	...
	const onDeleteArticle = useCallback(async (id: number) => {
		...
		},
		{
			...
			render: (article: Article) => (
				<Select
					...
					style={{ width: 80 }}
					onChange={(level) => updateArticle({ article_id: article.article_id, level })}
				>
